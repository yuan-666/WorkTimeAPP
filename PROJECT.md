...
- 最新功能发布提交：`v0.3.6` iOS 原生风格重构 + 拇指区交互 + 暗色修复 + 密码修改 + API 安全
- 最新发布说明：`RELEASE_NOTES.md`（推荐 Git 标签与 GitHub Release：`v0.3.6`）
- 版本规则：补丁号只走 `0` 到 `9`；超过 `9` 时进入下一小版本，因此原 `v0.2.10` 记为 `v0.3.0`，当前版本为 `v0.3.6`。
